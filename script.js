const appId = '9309cfa5'
const appKey= '3d6fa679528e96c78171d929de87c282'

const input = document.querySelector("input")
const button = document.querySelector("button")
const recipeContainer = document.querySelector(".recipe-container")

const generateRecipeCard = ({imageUrl, title, ingredientsArray, recipeUrl})=>`
...
<div class="p-5">
    ...
    ${ingredientsArray.length>0 && ingredientsArray.slice(0,5).join(' ⚪️ ')}</p>
...
const searchRecipe = async()=>{
    try{
        ...
        hits.forEach(({recipe}) => {
            ...
            card.innerHTML = generateRecipeCard({imageUrl: recipe.image, title: recipe.label, ingredientsArray: recipe.ingredientLines, recipeUrl: recipe.url})
